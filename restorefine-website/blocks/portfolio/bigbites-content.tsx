...
import { FileText, Printer, Type, ImageIcon } from "lucide-react";
...
const services = [
  ...
  { label: "Typography", icon: <Type size={14} /> },
  { label: "Food Photography Layout", icon: <ImageIcon size={14} /> },
];

const challenges = [
  { title: "Matching the Brand's Bold Personality", description: "The menus had to feel as punchy and no-nonsense as the Big Bites brand — generic restaurant templates simply wouldn't cut it." },
  { title: "Readability Under Pressure", description: "Counter-service menus need to be instantly scannable — customers shouldn't have to search for what they want when queues are building." },
  { title: "Driving Sales Through Design", description: "The layout needed to strategically guide customers towards best-sellers and higher-margin items without feeling manipulative." },
  { title: "Visual Consistency Across Locations", description: "With multiple sites, the design system needed to be robust enough to roll out consistently across every location." },
];

const strategy = [
  {
    title: "Brand-Led Design",
    items: ["Anchored the menu design in the existing Big Bites brand personality", "Used strong typographic hierarchy and bold colour blocking to create instant impact"],
  },
  {
    title: "Appetite-Driven Layouts",
    items: ["Positioned vivid food photography to drive desire and appetite appeal", "Structured sections and item groupings to maximise dwell time on key products"],
  },
  {
    title: "Print Production",
    items: ["Prepared print-ready files for multiple format sizes and locations", "Supplied both digital display and physical print versions of all menu assets"],
  },
];
...
const execution = [
  ...
  "Food photography placement",
  "Print-ready file preparation",
  "Digital display versions",
  "Multi-location format adaption",
];

const results = [
  "Staff reported faster customer decision-making at the counter following the menu redesign",
  "The brand's visual identity became instantly recognisable across all Big Bites locations",
  "Best-seller items saw increased order frequency due to improved visual prominence",
  "Consistent design rollout across multiple sites with minimal adaptation required",
];
...
export function BigBitesContent() {
  return (
    <>
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 border-t border-zinc-100">
      ...
      <div id="overview">
        ...
        <p className="text-zinc-600 text-base leading-relaxed max-w-3xl">
          RestoRefine partnered with Big Bites to design punchy, appetite-driven menus that match
          the energy and personality of their bold fast-food brand. The goal was to create a menu
          system that was easy to read, visually exciting, and strategically designed to sell —
          using strong typography, vivid food photography, and a clear visual hierarchy that guides
          customers quickly to the best sellers.
        </p>
      </div>
      ...
      <div id="execution">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl mb-6">
          RestoRefine delivered a complete menu design package for Big Bites, including:
        </p>
      ...
      <div id="design-work">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl mb-8">
          A look at the finished menu design delivered for Big Bites.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="relative overflow-hidden rounded-2xl bg-zinc-100 shadow-sm" style={{ aspectRatio: "16/9" }}>
            <Image src={designImages[0]} alt="Big Bites menu design — 1" fill className="object-cover transition-transform duration-500 hover:scale-[1.02]" loading="lazy" sizes="(max-width: 640px) 100vw, 50vw" />
          </div>
          <div className="relative overflow-hidden rounded-2xl bg-zinc-100 shadow-sm" style={{ aspectRatio: "16/9" }}>
            <Image src={designImages[1]} alt="Big Bites menu design — 2" fill className="object-cover transition-transform duration-500 hover:scale-[1.02]" loading="lazy" sizes="(max-width: 640px) 100vw, 50vw" />
          </div>
        </div>
      </div>
