...
const challenges = [
  { title: "Moving Beyond Generic Designs", description: "Everest Inn's previous menus looked similar to countless other restaurants — they needed something distinctively theirs." },
  { title: "Representing Nepalese Heritage", description: "The design had to honour the cultural depth of Nepalese cuisine without relying on tired visual clichés." },
  { title: "Matching the Quality of the Food", description: "The menu design needed to match the sophistication of the dining experience — premium food deserved a premium presentation." },
  { title: "Consistency Across the Restaurant", description: "The look and feel needed to carry through from the menu to the broader dining environment and brand communications." },
];

const strategy = [
  {
    title: "Cultural Research",
    items: ["Explored Himalayan visual culture, textiles, and architectural motifs", "Identified design elements that would resonate with both heritage diners and new audiences"],
  },
  {
    title: "Design Development",
    items: ["Crafted an elegant menu using rich earth tones and refined typography", "Incorporated subtle cultural motifs that evoke warmth and prestige of the Himalayan highlands"],
  },
  {
    title: "Print Production",
    items: ["Prepared premium print-ready files with bleed and print specifications", "Recommended paper stocks and finishing to match the restaurant's quality positioning"],
  },
];

const execution = [
  "Menu layout and typography",
  "Cultural motif illustration",
  "Colour palette development",
  "Print-ready file preparation",
  "Premium print specification",
  "Brand application guidance",
];

const results = [
  "The new menus elevated the overall dining experience and received immediate praise from guests",
  "Regular customers commented on the improvement and the enhanced sense of occasion",
  "The design has become a core part of Everest Inn's brand story, used consistently across touchpoints",
  "First-time guests consistently highlight the menus as a standout detail of the dining experience",
];
...
export function EverestInnContent() {
  return (
    <>
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 border-t border-zinc-100">
      ...
      <div id="overview">
        ...
        <p className="text-zinc-600 text-base leading-relaxed max-w-3xl">
          RestoRefine partnered with Everest Inn to design premium menus for a celebrated Nepalese
          restaurant with deep roots and a modern dining vision. Our goal was to move away from generic
          restaurant design towards something that truly represented the restaurant&apos;s Nepalese heritage —
          using rich earth tones, refined typography, and subtle cultural motifs to evoke the warmth and
          prestige of the Himalayan highlands.
        </p>
      </div>
      ...
      <div id="execution">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl mb-6">
          RestoRefine delivered a complete menu design package for Everest Inn, including:
        </p>
      ...
      <div id="design-work">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl mb-8">
          A look at the finished menu design delivered for Everest Inn.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="relative overflow-hidden rounded-2xl bg-zinc-100 shadow-sm" style={{ aspectRatio: "16/9" }}>
            <Image src={designImages[0]} alt="Everest Inn menu design — 1" fill className="object-cover transition-transform duration-500 hover:scale-[1.02]" loading="lazy" sizes="(max-width: 640px) 100vw, 50vw" />
          </div>
          <div className="relative overflow-hidden rounded-2xl bg-zinc-100 shadow-sm" style={{ aspectRatio: "16/9" }}>
            <Image src={designImages[1]} alt="Everest Inn menu design — 2" fill className="object-cover transition-transform duration-500 hover:scale-[1.02]" loading="lazy" sizes="(max-width: 640px) 100vw, 50vw" />
          </div>
        </div>
      </div>
