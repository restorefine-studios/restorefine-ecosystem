...
import { Share2, ImageIcon, Layers, BarChart } from "lucide-react";
...
const services = [
  ...
  { label: "Content Strategy", icon: <BarChart size={14} /> },
  { label: "Photography Guidelines", icon: <ImageIcon size={14} /> },
  { label: "Brand Templates", icon: <Layers size={14} /> },
];

const challenges = [
  { title: "A Compelling Vision, Poorly Communicated", description: "Our HQ had a strong community identity and vision for their space, but struggled to express it visually on social media." },
  { title: "Inconsistent Content", description: "Without a structured content strategy or templates, posts lacked consistency and the brand appeared disjointed across platforms." },
  { title: "Low Organic Reach", description: "Inconsistent posting and off-brand visuals meant the community wasn't growing at the rate the space deserved." },
  { title: "No Internal Content Tools", description: "The team needed tools they could use independently — without relying on an agency for every piece of content." },
];

const strategy = [
  {
    title: "Content Strategy",
    items: ["Developed a structured content strategy aligned with Our HQ's community identity and growth goals", "Defined content pillars and a posting framework for consistent execution"],
  },
  {
    title: "Visual Design",
    items: ["Produced a suite of branded social media assets and templates", "Ensured every design element aligned with the Our HQ brand identity"],
  },
  {
    title: "Team Enablement",
    items: ["Created photography guidelines so the internal team could capture on-brand content independently", "Delivered an editable template pack the team could update and post without design support"],
  },
];

const execution = [
  "Social media asset production",
  "Branded template suite",
...
const results = [
  "Our HQ saw a significant uplift in organic social media engagement following the redesign",
  "Several posts reached new audiences beyond their existing community for the first time",
  "The internal team gained confidence to post consistently using the templates and guidelines",
  "The brand's visual identity became coherent and recognisable across all digital platforms",
];
    ...
    <div className="max-w-7xl mx-auto px-6 md:px-12 py-16 border-t border-zinc-100">
      ...
      <div id="overview">
        ...
        <p className="text-zinc-600 text-base leading-relaxed max-w-3xl">
          RestoRefine partnered with Our HQ to develop content creation assets and a social media
          strategy for a co-working space with a strong community identity. Our goal was to give
          the team the tools to communicate their vision consistently and confidently — through a
          content strategy, a suite of branded social assets, and a photography style guide that
          empowers the internal team to create on-brand content independently.
        </p>
      </div>
      ...
      <div id="execution">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl mb-6">
          RestoRefine delivered a complete social media and content package for Our HQ, including:
        </p>
      ...
      <div id="design-work">
        ...
        <p className="text-zinc-500 text-sm leading-relaxed max-w-2xl mb-8">
          A sample of the branded social media content created for Our HQ.
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {designImages.map((src, i) => (
            <div key={i} className="relative overflow-hidden rounded-2xl bg-zinc-100 shadow-sm" style={{ aspectRatio: "16/9" }}>
              <Image
                src={src}
                alt={`Our HQ social media post — ${i + 1}`}
                fill
