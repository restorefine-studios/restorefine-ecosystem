...
interface NotFoundScreenProps {
  ...
  eyebrow?: string;
  /** First heading line, rendered in black. */
  headingLead: string;
...
/**
 * Shared 404 screen. Every not-found boundary on the site renders this so a
 * missing case study looks the same as a missing page.
 */
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-6 md:px-12 lg:px-24 py-32 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 max-w-2xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-black uppercase tracking-tight text-zinc-900 leading-[0.9]">
            {headingLead}{" "}
            <span className="text-red-600">{headingAccent}</span>
          </h1>

          {/* Subtext */}
          <p className="text-sm text-zinc-500 leading-relaxed max-w-sm mt-2">{body}</p>
          ...
          {/* CTA */}
          <Link href={ctaHref} className="flex items-center gap-2 group mt-2">
