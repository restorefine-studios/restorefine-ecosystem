...
export const metadata: Metadata = {
  title: "RestoBranding — Restaurant Brand Identity Design",
  description:
    "Build a bold, memorable brand for your restaurant with RestoRefine's RestoBranding service. Logo design, brand identity systems, brand guidelines, and visual asset kits — crafted for hospitality.",
  keywords: [
    ...
    "RestoBranding",
    "restaurant rebrand UK",
  ],
  alternates: { canonical: "https://www.restorefine.co.uk/services/restobranding" },
  openGraph: {
    title: "RestoBranding | RestoRefine",
    description:
      "Logo design, brand identity, and visual systems built exclusively for restaurants and hospitality brands.",
    url: "https://www.restorefine.co.uk/services/restobranding",
  },
};
...
async function fetchBrandingData() {
  ...
  const fallbackFeatures = [
    {
      title: 'Logo Design',
      description: 'A distinctive mark built to last. We craft logos that are bold, versatile, and unmistakably yours — across every format and size.',
      image: '/services/branding/pexels-duygugungor-19949505.webp',
    },
    {
      title: 'Brand Identity System',
      description: 'Colour palettes, typography, and visual language that work together seamlessly — giving your brand a cohesive, professional presence.',
      image: '/services/branding/pexels-mikael-blomkvist-6476579.webp',
    },
    {
      title: 'Brand Guidelines',
      description: 'A comprehensive guide covering every touchpoint, so your brand stays consistent whether it\'s on a menu, a social post, or a storefront.',
      image: '/services/branding/pexels-beyzaa-yurtkuran-279977530-17789088.webp',
    },
    {
      title: 'Visual Asset Kits',
      description: 'Icons, patterns, and branded graphic elements — everything your team needs to stay on-brand without starting from scratch.',
  ...
  return {
    ...
    overview: { title: mainServiceTitle, subtitle: mainServiceSubtext, features: resolvedFeatures },
