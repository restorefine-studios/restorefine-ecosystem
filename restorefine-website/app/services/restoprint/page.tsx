...
export const metadata: Metadata = {
  title: "RestoPrint — Restaurant Print Design & Collateral",
  description:
    "High-quality print design for restaurants with RestoRefine's RestoPrint service. Menus, flyers, business cards, signage, and all printed collateral — designed to impress.",
  keywords: [
    "restaurant menu design UK",
    "restaurant print design",
    "hospitality print collateral",
    "restaurant flyer design",
    "café menu design UK",
    "restaurant signage design",
    "restaurant business card design",
    "RestoPrint",
    "food brand print design UK",
  ],
  alternates: { canonical: "https://www.restorefine.co.uk/services/restoprint" },
  openGraph: {
    title: "RestoPrint | RestoRefine",
    description:
      "Professional print design for restaurants — menus, signage, flyers, and branded collateral.",
    url: "https://www.restorefine.co.uk/services/restoprint",
  },
};
