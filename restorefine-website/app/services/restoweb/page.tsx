...
export const metadata: Metadata = {
  title: "RestoWeb — Restaurant Website Design & Development",
  description:
    "RestoRefine's RestoWeb service delivers stunning, high-performance websites for restaurants and hospitality brands in the UK. Custom design, fast loading, and built to convert visitors into diners.",
  keywords: [
    "restaurant website design UK",
    "restaurant web development",
    "hospitality website design",
    "café website design UK",
    "restaurant website agency",
    "food business website design",
    "restaurant online presence",
    "RestoWeb",
    "restaurant website builder UK",
  ],
  alternates: { canonical: "https://www.restorefine.co.uk/services/restoweb" },
  openGraph: {
    title: "RestoWeb | RestoRefine",
    description:
      "Custom restaurant websites designed to engage, impress, and convert — built by the RestoRefine team.",
    url: "https://www.restorefine.co.uk/services/restoweb",
  },
};
