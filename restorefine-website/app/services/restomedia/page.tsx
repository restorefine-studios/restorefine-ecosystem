...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Professional food photography and videography for restaurants, cafés, and hospitality brands across the UK.",
    url: "https://www.restorefine.co.uk/services/restomedia",
  },
};
